...
class My3x3PixelMapper : public PixelMapper {
public:
  My3x3PixelMapper() {}

  virtual const char *GetName() const { return "3x3"; }
  ...
  virtual void MapVisibleToMatrix(int matrix_width, int matrix_height,
      ...
      *matrix_x = x + ((y/matrix_height)*matrix_width/3);
...
static MapperByName *CreateMapperMap() {
  ...
  RegisterPixelMapperInternal(result, new My3x3PixelMapper());
